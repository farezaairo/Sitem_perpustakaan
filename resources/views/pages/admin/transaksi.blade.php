...
<div id="transactionsPage" class="content-page p-6">
    ...
    <div class="bg-white rounded-2xl p-6 shadow-lg">
        ...
        <div class="mb-6 flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div class="w-full">
                <label class="text-gray-700 font-medium mb-1">Cari Nama Siswa</label>
...
document.addEventListener('DOMContentLoaded', function(){
    ...
    function loadTransactions(){
        ...
        transactionsContainer.innerHTML = `
            <tr>
                <td colspan="7" class="text-center py-4">Memuat...</td>
            </tr>
        `;
        ...
        .then(res => {
            ...
            transactionsContainer.innerHTML = data.map(t => {
                ...
                let actionButtons = `
                    <button onclick="hapusTransaction('${t.id_transaksi}')"
                ...
                if(t.status === 'dipinjam' || t.status === 'terlambat'){
                    actionButtons = `
                        <button onclick="kembalikanTransaction('${t.id_transaksi}')"
    ...
    searchInput.addEventListener('keyup', loadTransactions);
